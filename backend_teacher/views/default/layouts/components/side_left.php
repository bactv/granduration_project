...
use backend_teacher\models\Menu;
?>
    ...
    <div class="person">
        <div class="row avatar">
            ...
            if (isset(Yii::$app->user->identity->tch_avatar) && Yii::$app->user->identity->tch_avatar > 0) {
                $avatar = Yii::$app->params['storage_url'] . Yii::$app->params['img_url']['avatar_teacher']['folder'] . '/' . Yii::$app->user->identity->tch_id . '.png';
            }
            ?>
            <?php echo Html::img($avatar, ['alt' => 'admin']) ?>
        </div>
        <div class="row username">
            <?php echo Yii::$app->user->identity->tch_username ?>
        </div>
    </div>
</div>
