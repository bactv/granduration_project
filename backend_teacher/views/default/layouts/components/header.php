        ...
        <li class="person_info dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <span id="avatar">
                    ...
                    if (isset(Yii::$app->user->identity->tch_avatar) && Yii::$app->user->identity->tch_avatar > 0) {
                ...
                <span id="username"><?php echo Yii::$app->user->identity->tch_username ?></span>
                <span id="chevron_icon"><?php echo Icon::show('chevron-right') ?></span>
                <ul class="dropdown-menu">
                    <li><a href="<?php echo \yii\helpers\Url::toRoute(['/admin/update', 'id' => Yii::$app->user->identity->tch_id]) ?>"><?php echo Icon::show('cogs') ?> Cập nhật thông tin</a></li>
