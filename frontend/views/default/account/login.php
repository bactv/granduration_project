...
<?php if (empty($type)) { ?>
    ...
    <div class="confirm-stu-or-tch">
        <?php echo Html::a('Bạn là giáo viên ? >>', ['/account/login', 'type' => 'teacher'], ['class' => 'btn btn-info', 'id' => 'btn-confirm']) ?>
        <?php echo Html::a('Bạn là học sinh ? >>', ['/account/login', 'type' => 'student'], ['class' => 'btn btn-warning', 'id' => 'btn-confirm']) ?>
    </div>
