...
<div class="confirm-stu-or-tch">
    <?php echo Html::a('Bạn là giáo viên ? >>', ['/account/create-account', 'type' => 'teacher'], ['class' => 'btn btn-info', 'id' => 'btn-confirm']) ?>
    <?php echo Html::a('Bạn là học sinh ? >>', ['/account/create-account', 'type' => 'student'], ['class' => 'btn btn-warning', 'id' => 'btn-confirm']) ?>
</div>
